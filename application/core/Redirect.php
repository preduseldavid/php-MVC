...
class Redirect
{
     ...
     * by Redirect::to() when using phpMVC inside sub-folders.
     *
     * @param $path string
     */
     ...
     *
     * Redirects to a RELATIVE path, like "user/profile" (which works very fine unless you are using phpMVC inside tricky
